...
██   ██ ██      ██      ██      ██      ██   ██ 
██████  ███████ ███████ ██      ███████ ██   █
 >> Crack Hash Wpa2 & More : Balaha:HackCode0x1
                           """+Style.RESET_ALL)
                    print('Output:')
...
def Hashcrack():
    ...
    verbose = 'False'
    wordlistToUse = input('[#]Shell@Wordlist>> ')
    while wordlistToUse not in [str] :
        print("INVALID CHOICE! Insert Path to wordlist\n")
        wordlistToUse = input('[#]Shell@Wordlist>> ')
        if wordlistToUse == "":
            continue
        else:
    ...
    print(Fore.MAGENTA+'Wordlist> '+Style.RESET_ALL+wordlistToUse)
    hashToCrack = input('[#]Shell@Hash>> ')
    while hashToCrack not in [str] :
        print("INVALID CHOICE! Insert Hash to crack\n")
        hashToCrack = input('[#]Shell@Hash>> ')
        if hashToCrack =="":
            continue
        else:
    ...
    print(Fore.MAGENTA+'Hash> '+Style.RESET_ALL+hashToCrack)
    algorithmToUse = input ('[#]Shell@Algorithm>> ')
    while algorithmToUse not in [str] :
        print("INVALID CHOICE! Insert Hash to crack\n")
        algorithmToUse = input ('[#]Shell@Algorithm>> ')
        if algorithmToUse =="":
            continue
            ...
            for word in tqdm.tqdm(wordlistFile,total=counter, unit="Word"):
                ...
                if h.hexdigest() == hash:
                    ...
                    if verbose =='False':
                        ...
                        print('['+Fore.LIGHTRED_EX+"+"+Style.RESET_ALL+"]"+' did not match! Moving onto next guess.......... '+word.strip()+Style.RESET_ALL)
...
print('[1] Crack Hash')
print('[2] Hash identifie')
print('[3] Hashing')
print('[4] Crack list of hash')
print('[5] Crack Hash Mode <<Bruteforce')
